...
public class SixMonthsLoanStrategyService implements LoanStrategy {
     ...
     * Interest rate
     */
    private static final Double INTEREST_RATE = InterestRateEnum.ZERO_POINT_ONE.getValue();

    /**
     * Return loan by six months strategy
     *
    ...
    /**
     * Return loan installments by six months strategy
     *
     * @param loan loan
