 ...
 */
@Service
public class TwelveMonthsLoanStrategyService implements LoanStrategy {

    /**
     * Installment number
     */
    private static final Integer INSTALLMENT_NUMBER = InstallmentNumberEnum.TWELVE.getValue();

    /**
     * Interest rate
     */
    private static final Double INTEREST_RATE = InterestRateEnum.ZERO_POINT_THREE.getValue();

    /**
     * Return loan by twelve months strategy
     *
    ...
    /**
     * Return loan installments by twelve months strategy
     *
     * @param loan loan
