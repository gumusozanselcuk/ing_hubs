...
import com.inghubs.creditmodule.service.loanstrategy.TwelveMonthsLoanStrategyService;
...
public class TwelveMonthsLoanStrategyServiceTest {

    @InjectMocks
    private TwelveMonthsLoanStrategyService twelveMonthsLoanStrategyService;
    ...
    public void testGetLoanToBeCreatedByStrategy() {
        ...
        Loan loan = twelveMonthsLoanStrategyService.getLoanToBeCreatedByStrategy(loanCreationRequestDTO);
        ...
        assertEquals(12, loan.getNumberOfInstallment());
    }
    ...
    public void testGetLoanInstallmentsOfLoanByStrategy() {
        ...
        List<LoanInstallment> loanInstallments = twelveMonthsLoanStrategyService.getLoanInstallmentsOfLoanByStrategy(loan);

        assertNotNull(loanInstallments);
        assertEquals(12, loanInstallments.size());

        Double installmentAmount = (1000.0 * 1.3) / 12;
    ...
    public void testGetType() {
        String type = twelveMonthsLoanStrategyService.getType();
        assertEquals("12", type);
    }
}
