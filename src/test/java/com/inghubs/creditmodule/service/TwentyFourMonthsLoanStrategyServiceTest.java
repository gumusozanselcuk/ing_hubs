...
import com.inghubs.creditmodule.service.loanstrategy.TwentyFourMonthsLoanStrategyService;
...
public class TwentyFourMonthsLoanStrategyServiceTest {
    @InjectMocks
    private TwentyFourMonthsLoanStrategyService twentyFourMonthsLoanStrategyService;
    ...
    public void testGetLoanToBeCreatedByStrategy() {
        ...
        Loan loan = twentyFourMonthsLoanStrategyService.getLoanToBeCreatedByStrategy(loanCreationRequestDTO);
        ...
        assertEquals(24, loan.getNumberOfInstallment());
    }
    ...
    public void testGetLoanInstallmentsOfLoanByStrategy() {
        ...
        List<LoanInstallment> loanInstallments = twentyFourMonthsLoanStrategyService.getLoanInstallmentsOfLoanByStrategy(loan);

        assertNotNull(loanInstallments);
        assertEquals(24, loanInstallments.size());

        Double installmentAmount = (1000.0 * 1.5) / 24;
    ...
    public void testGetType() {
        String type = twentyFourMonthsLoanStrategyService.getType();
